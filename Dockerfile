...
# The following unknown_registry custom nodes could not be resolved because they lack an aux_id (GitHub repo) and must be provided or installed manually:
# - Note
# - MarkdownNote
# - Note
# - Note
...
RUN comfy model download --url https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/audio_encoders/wav2vec2_large_english_fp16.safetensors --relative-path models/audio_encoders --filename wav2vec2_large_english_fp16.safetensors
